      ...
      <div className="bg-white px-8 py-8 border rounded w-full max-w-4xl max-h-[80vh] overflow-y-scroll ">
        <div className="flex items-center gap-4 mb-8 text-gray-500">
          <label htmlFor="doc-img">
            <img
              className="w-16 bg-gray-100 rounded-full cursor-pointer border border-primary "
          ...
          <div className="w-full lg:flex-1 flex flex-col gap-1">
            <div className="flex-1 flex flex-col gap-1">
              ...
              <input
                ...
                className="border rounded px-3 py-2 border-primary"
                type="text"
                placeholder="Name"
                required
              />
        ...
        <div className="flex-1 flex flex-col gap-1">
          ...
          onChange={(e)=>setAbout(e.target.value)} value={about}
            className="w-full px-4 pt-2 border rounded border-primary"
            rows={5}
