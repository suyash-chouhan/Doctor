...
const Header = () => {
  return (
    <div className='flex flex-col md:flex-row flex-wrap bg-primary rounded-lg px-4 md:px-10 lg:px-20 '>
      
      {/* ----------Left side---------- */}
      <div className='md:w-1/2 flex flex-col items-start justify-center gap-4 py-45 m-auto md:py[-10vw] md:mb-[-30px]'>
